...
plot(cc14[ 1, ], col = 'black', pch=16, ylim=c(0, 400), xlab = 'Played Id', ylab = 'Weighted Lifted lbs')
#second column in yellow triangles 
points(cc14[ 2, ], col = 'red', pch=17, title(main = 'Back Squat Performance', sub = 'September 2014 (black) to September 2015 (red)'))

mean(cc14[2,]) - mean(cc14[1,])